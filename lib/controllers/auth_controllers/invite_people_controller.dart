...
class InvitePeopleController extends GetxController {
  ...
  getAllUnRegisterUser() async {
    ...
    debugPrint(
        "ppCtrl.unRegisterContact : ${appCtrl.unRegisterContact.length}");
  ...
  onInvitePeople({number}) async {
    try {
      Share.share(
          "Let's chat on Rex! It's a fast, simple, and secure app we can use to message and call our friends for free.https://play.google.com/store/apps/details?id=com.rexapp.chat");
    } catch (e) {
