 ...
 stream = FirebaseFirestore.instance
  ...
  onSearch(val)async {
    ...
    QuerySnapshot<Map<String, dynamic>> query1 = await FirebaseFirestore
        ...
        .doc(appCtrl.user["id"])
        .collection(collectionName.collectionCallHistory)
        .where("callerName", isGreaterThanOrEqualTo: val.toString().toLowerCase())
        .get();
    ...
    QuerySnapshot<Map<String, dynamic>> query2 = await FirebaseFirestore
        ...
        .doc(appCtrl.user["id"])
        .collection(collectionName.collectionCallHistory)
        .where("receiverName",isGreaterThanOrEqualTo: val.toString().toLowerCase())
        .get();
    ...
    QuerySnapshot<Map<String, dynamic>> query3 = await FirebaseFirestore
        ...
        .doc(appCtrl.user["id"])
        .collection(collectionName.collectionCallHistory)
        .where("callerName",isGreaterThanOrEqualTo: val.toString().capitalizeFirst)
        .get();
    QuerySnapshot<Map<String, dynamic>> query4 = await FirebaseFirestore
        ...
        .doc(appCtrl.user["id"])
        .collection(collectionName.collectionCallHistory)
        .where("receiverName",isGreaterThanOrEqualTo: val.toString().capitalizeFirst)
        .get();
