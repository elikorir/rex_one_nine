...
import 'package:chatzy/screens/app_screens/wallpaper_screen/background_list.dart';
...
import '../screens/app_screens/video_call/video_call.dart';
...
class AppRoute {
  final List<GetPage> getPages = [
    ...
    GetPage(name: _routeName.profileSetupScreen, page: () => ProfileSetupScreen()),
    GetPage(name: _routeName.invitePeopleScreen, page: () => const InvitePeopleScreen()),
    ...
    GetPage(name: _routeName.fingerScannerScreen, page: () =>  FingerPrintScreen()),
    GetPage(name: _routeName.profileScreen, page: () =>  ProfileScreen()),
    GetPage(name: _routeName.statusView, page: () =>  const StatusScreenView()),
    GetPage(name: _routeName.groupMessageScreen, page: () =>  GroupMessageScreen()),
    ...
    GetPage(name: _routeName.editGroupDetailScreen, page: () =>  EditGroupDetailScreen()),
