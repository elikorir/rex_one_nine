      ...
      return AppBar(
        ...
        shape: const SmoothRectangleBorder(
            borderRadius: SmoothBorderRadius.vertical(
                bottom: SmoothRadius(cornerRadius: 20, cornerSmoothing: 1))),
        ...
        actions: [
          PopupMenuButton(
                  ...
                  itemBuilder: (ctx) => [
                        _buildPopupMenuItem(
                            appFonts.viewInfo, eSvgAssets.viewInfo, 0),
                        _buildPopupMenuItem(
                            appFonts.wallpaper, eSvgAssets.wallpaper, 1),
                        _buildPopupMenuItem(
                            appFonts.clearChat, eSvgAssets.trash, 2,
                            isDivider: false),
                      ],
