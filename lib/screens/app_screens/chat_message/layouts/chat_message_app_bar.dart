          ...
          child: InkWell(
            ...
            child: Container(
              ...
              child: AppBar(
                  ...
                  titleSpacing: 0,
                  leading:
                      SvgPicture.asset(appCtrl.isRTL || appCtrl.languageVal == "ar" ? eSvgAssets.arrowRight : eSvgAssets.arrowLeft,
                                  ...
                                  children: [
                                    ...
                                    BackdropFilter(
                                        ...
                                        child: PopupMenuButton(
                                                  ...
                                                  if (result == 1) {
                                                    ...
                                                    Clipboard.setData(ClipboardData(
                                                        text: decryptMessage(chatCtrl
                                                                ...
                                                                .contains(
                                                                    "-BREAK-")
                                                            ? decryptMessage(chatCtrl.message[index].data()["content"]).split(
                                                                "-BREAK-")[1]
                                                ...
                                                offset:
                                                    Offset(0.0, appBarHeight),
                                                shape: RoundedRectangleBorder(
                                                    borderRadius:
                                                        BorderRadius.circular(
                                                            AppRadius.r8)),
                                                itemBuilder: (ctx) => chatCtrl
                                                        .selectedIndexId
                                                        .isNotEmpty
                                                    ? [
                                                        _buildPopupMenuItem(
                                            ...
                                            .newBoxDecoration()
                                            .marginSymmetric(vertical: Insets.i20)
                                            .marginOnly(right: appCtrl.isRTL || appCtrl.languageVal == "ar" ? 0 : Insets.i20, left: appCtrl.isRTL || appCtrl.languageVal == "ar" ? Insets.i20 : 0)),
                                  ],
                                );
                              })
                  ],
                  title: chatCtrl.selectedIndexId.isNotEmpty
                      ...
                      : chatCtrl.isChatSearch
                          ...
                          : Row(
                              ...
                              onTap: () => Get.toNamed(routeName.chatUserProfile))),
            ),
          ));
    });
  }
