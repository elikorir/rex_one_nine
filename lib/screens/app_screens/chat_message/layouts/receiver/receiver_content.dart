...
class ReceiverContent extends StatelessWidget {
  ...
  const ReceiverContent({super.key, this.document, this.onLongPress, this.onTap,this.emojiTap})
  ;
                ...
                child: Column(
                  ...
                  children: [
                    Text(decryptMessage(document!.content),
                        style: document!.type == MessageType.emoji.name ?AppCss.manropeSemiBold24
                            .textColor(appCtrl.appTheme.sameWhite)
                            .letterSpace(.2)
                            .textHeight(1.2) : AppCss.manropeSemiBold14
