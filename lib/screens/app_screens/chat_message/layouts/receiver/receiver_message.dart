              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: <
                ...
                Row(
                  children: <Widget>[
                    ...
                    if (widget.document!.type == MessageType.text.name ||widget.document!.type == MessageType.emoji.name )
                      ReceiverContent(
                          emojiTap:()=> OnTapFunctionCall()
                              .onEmojiRemove(chatCtrl, widget.docId, "",widget.title,widget.document!.content),
                          onLongPress: () =>
                    ...
                    if (widget.document!.type == MessageType.doc.name)
                      (decryptMessage(widget.document!.content).contains(
                          ".pdf"))
                          ? PdfLayout(
                          isReceiver: true, emojiTap:()=> OnTapFunctionCall()
                          .onEmojiRemove(chatCtrl, widget.docId, "",widget.title,widget.document!.content),
                          document: widget.document,
                          onTap: () =>
                    ...
                    if(widget.document!.type == MessageType.link.name)
                      ...
                      CommonLinkLayout(
                          isReceiver: true,
                          document: widget.document, onRemoveEmoji:()=> OnTapFunctionCall()
                          .onEmojiRemove(chatCtrl, widget.docId, "",widget.title,widget.document!.content),
