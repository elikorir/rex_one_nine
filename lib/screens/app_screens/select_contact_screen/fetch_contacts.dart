                            ...
                            children: [
                                      ...
                                      : ListTileLayout(
                                          ...
                                          onTap: () {
                                            if (e.key == 0) {
                                              ...
                                              Get.toNamed(routeName.newContact)!
                                                  .then((value) {
                                                return availableContacts
                                                    .fetchContacts(
                                                        context,
                                                                ...
                                                                child: Text(
                                                                    snapshot
                                                                        ...
                                                                        ? snapshot.data!.name.length >
                                                                                2
                                                                            ? snapshot.data!.name.replaceAll(" ", "").substring(0, 2).toUpperCase()
                              ...
                              ListView.builder(
                                  ...
                                  itemCount: inviteContactsCount >=
                                      (availableContacts
                                          .searchContactList!.isNotEmpty
                                          ? availableContacts
                                          .searchContactList!.length
                                          : availableContacts
                                          .contactList!.length)
                                      ? (availableContacts
                                      .searchContactList!.isNotEmpty
                                  ...
                                  itemBuilder: (context, idx) {
                                    MapEntry user = availableContacts
                                        ...
                                        .elementAt(idx)
                                        : availableContacts.contactList!.entries
                                        .elementAt(idx);
                                    String phone = user.key;

                                    return availableContacts.registerContactUser
                                        .indexWhere((element) =>
                                    element.phone == phone) >= 0
                                        ? Container()
                                        : availableContacts.oldPhoneData.indexWhere((element) =>
                                    element.phone == phone) >= 0
                                        ?  Container()
                                        : UnRegisterUser(
