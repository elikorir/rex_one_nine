                          ...
                          children: [
                            SizedBox(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    Image.asset(eImageAssets.appIcon,height: 80,width: 80,),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                      ...
                                      Text(appFonts.otpSentTo.tr,
                                          style: AppCss.manropeSemiBold14
                                              .textColor(
                                                  appCtrl.appTheme.greyText)),
                                      Text(
                                          "${loginCtrl.dialCode } ${loginCtrl.numberController.text.toString()}",
                                          style: AppCss.manropeSemiBold14
                                              .textColor(
                                                  appCtrl.appTheme.greyText))
                                    ]),
                                    ...
                                    OtpLayout(
                                        ...
                                        defaultPinTheme:
                                            loginCtrl.defaultPinTheme,
                                        errorPinTheme: loginCtrl.defaultPinTheme.copyWith(
                                            decoration: BoxDecoration(
                                                ...
                                                borderRadius:
                                                    BorderRadius.circular(
                                                        AppRadius.r8))),
                                        focusedPinTheme:
                                            loginCtrl.defaultPinTheme.copyWith(
                                                height: Sizes.s48,
                                                width: Sizes.s55,
                                    ...
                                    ButtonCommon(title: appFonts.verify.tr)
                                        .inkWell(
                                            onTap: () =>
                                                loginCtrl.onFormSubmitted()),
