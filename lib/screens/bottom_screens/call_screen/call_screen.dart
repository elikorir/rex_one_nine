          ...
          return Scaffold(
                  ...
                  body: ListView(
                      ...
                      children: [
                        ...
                        if (callListCtrl.searchText.text.isNotEmpty)
                          callListCtrl.results.isEmpty
                              ? Column(
                              ...
                              : CallListLayout(results: callListCtrl.results),
                        if (callListCtrl.searchText.text.isEmpty)
                          StreamBuilder(
