    ...
    return InkWell(
      onTap: () {
        ...
        Get.toNamed(routeName.statusView,
            arguments: {"status": status, "isSponsor": widget.isSponsor});
      },
      child: Column(
                              ...
                              painter: DottedBorders(
                                  ...
                                  spaceLength:
                                      widget.snapshot!.photoUrl!.length == 1
                                          ? 0
                                          : 4)))),
                  if (widget.snapshot!.photoUrl!.isNotEmpty)
                    widget.snapshot!.photoUrl![widget.snapshot!.photoUrl!.length - 1].statusType ==
                        ...
                        ? Container(
                            ...
                            decoration: BoxDecoration(
                                color: Color(
                                    int.parse(widget.snapshot!.photoUrl![widget.snapshot!.photoUrl!.length - 1].statusBgColor!,
                                        radix: 16)),
                        ...
                        : widget.snapshot!.photoUrl![widget.snapshot!.photoUrl!.length - 1].statusType ==
                            ...
                            ? CachedNetworkImage(
                                imageUrl:
                                    widget.snapshot!.photoUrl![widget.snapshot!.photoUrl!.length - 1].image
                                        .toString(),
