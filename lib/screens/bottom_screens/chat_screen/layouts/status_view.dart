                  ...
                  children: [
                    StoryView(
                      ...
                      onStoryShow: (s,index) async {
                        ...
                        statusViewCtrl.selectedIndex =
                            statusViewCtrl.selectedIndex + 1;
                        statusViewCtrl.position = statusViewCtrl.position + 1;
                        if ((statusViewCtrl.position - 1) <
                          ...
                          if(isSponsor){
                            FirebaseFirestore.instance
                              ...
                              if (doc.docs.isNotEmpty) {
                                ...
                                bool isSeen = photoUrl[statusViewCtrl.lastPosition]
                                    .seenBy!
                                    .where((element) =>
                                ...
                                if (!isSeen) {
                                  ...
                                  log("SEEN L %${photoUrl[statusViewCtrl
                                      .lastPosition].seenBy}");
                                  FirebaseFirestore.instance
                                      .collection(collectionName.adminStatus)
                                      .doc(doc.docs[0].id)
                                ...
                                if (statusViewCtrl.position ==
                                    statusViewCtrl.status!.photoUrl!.length) {
                                  List seenAll = statusViewCtrl.status!
                                      .seenAllStatus ?? [];
                                  if (!seenAll.contains(
                                      statusViewCtrl.status!.uid)) {
                            ...
                            log("CJHJHJJ ${statusViewCtrl.status!.uid}");
                            FirebaseFirestore.instance
                                .collection(collectionName.users)
                                .doc(statusViewCtrl.status!.uid)
                              ...
                              if (doc.docs.isNotEmpty) {
                                ...
                                List<PhotoUrl> photoUrl = getStatus.photoUrl!;
                                bool isSeen = photoUrl[statusViewCtrl
                                    .position]
                                    .seenBy!
                                    .where((element) =>
                                element["uid"] == appCtrl.user["id"])
                                ...
                                log("ISS ;$isSeen");
                                if (!isSeen) {
                                  photoUrl[statusViewCtrl.position]
                                      .seenBy!
                                      .add(
                                      {
                                        "uid": appCtrl.user["id"],
                          ...
                          if (statusViewCtrl.status!.uid ==
                            ...
                            FirebaseFirestore.instance
                              ...
                              if (doc.docs.isNotEmpty) {
                                ...
                                photoUrl[statusViewCtrl.position].seenBy!;
                                statusViewCtrl.update();
                              }
                            });
                              ...
                              children: [
                                Column(
                                    ...
                                    children: [
                                       SizedBox(
                                        ...
                                        child: Row(
                                            ...
                                            mainAxisAlignment: MainAxisAlignment
                                                .start,
                                            children: statusViewCtrl.seenBy
                                                .asMap()
                                                .entries
                                                .map((e) {
                                              return StreamBuilder(
                                                  ...
                                                  builder: (context, snapshot) {
                                                    ...
                                                    seenList = statusViewCtrl.seenBy.length;
                                      ...
                                      const VSpace(Sizes.s5),
                                      Text(
                                          "${appFonts.seenBy.tr} ${statusViewCtrl.seenBy.length} ",
